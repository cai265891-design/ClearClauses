...
export default function Header({ header }: { header: HeaderType }) {
  ...
  return (
    <section className="sticky top-0 z-50 py-3 backdrop-blur-md bg-white/30 supports-[backdrop-filter]:bg-white/25 border-b border-black/5">
