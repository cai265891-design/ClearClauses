...
重要原则：
- 合同正文只根据 brief 写，不根据 kb 硬塞额外条款
- kb 只用来写解释和【行业常见做法】的说明，不做法律结论
...
保存近 30 天的合同记录
三、相关 API
API key：sk-MrT2AoXeql64BEIyuOfPnq7AZQJvfiuAD0ZmgyjcslLPnIy8
APIkey 不做硬编码，写在环境变量里面
ContractIntake API
使用gpt-5-mini
generate API
使用：gpt-5.1-2025-11-13
优化合同条款
使用：gpt-5.1-2025-11-13
